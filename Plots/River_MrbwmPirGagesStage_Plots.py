...
Description: Creates stage plots of gages in the Oahe-Bend reach used for ice determination.
...
PlotFilename = ImagesDirectory + '%sice.jpg'
...
# Dictionary of data
LocationProperties = {  # Stations
                        'PIR'               :    {  'PlotTitle'         :   'Missouri River at Pierre, SD (RM 1066.5)\nDatum = 1414.26 ft',
                        ...
                        'LFSD'              :    {  'PlotTitle'         :   'Missouri River at LaFrambois Island, SD (RM 1064.8)\nDatum = 1400.0 ft',
                        ...
                        'IWSD'              :    {  'PlotTitle'         :   'Missouri River at Isaac Walton, SD (RM 1062.8)\nDatum = 1400.0 ft',
                        ...
                        'FISD'              :    {  'PlotTitle'         :   'Missouri River at Farm Island, SD (RM 1059.8)\nDatum = 1400.0 ft',
...
MarkerProperties =  {
                        ...
                        #    -----------------------          -----------------------    -------------        --------  -----------    -------------------------------------      ------------       ------------   ---------------    ------------    ------------    ----------     ----------   -----------        
                            'PpNotStage'                :   [ True,                      None,                None,     None,          'PowerPlant Notification Elevation',       'Arial,Plain,12',  'Y1',          'left',            'below',        'darkred',      'Dash Dot',    'darkred',   1],         
                            'TargetStage'               :   [ True,                      None,                None,     None,          'Target Elevation',                        'Arial,Plain,12',  'Y1',          'left',            'below',        'magenta',      'Dash Dot',    'magenta',   1],        
                            'CriticalStage'             :   [ True,                      None,                None,     None,          'Critical Elevation',                      'Arial,Plain,12',  'Y1',          'left',            'above',        'darkcyan',     'Dash Dot',    'darkcyan',  1],        
                    }
...
try :
    ...
    # Date and time
    #
    Lookback    = 7 # Number of days to lookback and set the start of the time window
    ...
    for location in Locations :
        try :
            ...
            # Assign warning levels from the LocationProperties dictionary to the MarkerProperties dictionary
            #    There is a place holder in the MarkerProperties dictionary.
            for key in MarkerProperties.keys() :
                if MarkerProperties[key][0] :
                    # Retrieve value
                    ZoneValue = LocationProperties[location][key]
