...
Description: Creates elevation, inflow, and outflow plots for the mainstem reservoirs in the Missouri River Basin.
        ...
        try :
            ...
            for key in MarkerProperties.keys() :
                if MarkerProperties[key][0] :
                    # Retrieve value
                    ZoneFullName = MarkerProperties[key][1] % location#LocationProperties[location]['DbLocation']
