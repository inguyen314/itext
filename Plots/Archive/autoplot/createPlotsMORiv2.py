...
# define the plot layout
		...
		plot.showPlot()
		plot.setLegendLabelText(flow1DC,"Rulo-Missouri")
		plot.setLegendLabelText(flow2DC,"St Joseph-Missouri")
		plot.setLegendLabelText(flow3DC,"Kansas City-Missouri")
		plot.setLegendLabelText(flow4DC,"Waverly-Missouri")
		plot.setLegendLabelText(flow5DC,"Boonville-Missouri")
		plot.setLegendLabelText(flow6DC,"Hermann-Missouri")
...
#
dbiName     = "fooooo"
iniFilename = "/cwms/g7cwmspd/plotFiles/plotDataMORiv2.ini"
