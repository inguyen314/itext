...
# read the data from the CWMS Oracle database via the DBI from the ini data file
	...
	flowData = TimeSeriesMath(flowData)
	flowDataKcfs = flowData.divide(1000.)
	flowDataKcfs.setUnits("kcfs")
	flowDataKcfs2 = flowDataKcfs.getData()
...
# define the plot, add data, etc.		
	...
	#	plot.addData(toLocalTime(flowDataKcfs2))
                plot.addData(stageData)
                plot.addData(flowDataKcfs2)
...
#
dbiName     = "foo"
iniFilename = "/cwms/g7cwmspd/plotFiles/plotDataMRRmainstem-qgh.ini"
