...
#
# customize the second graph on the plot (elev, inflow and release) ... viewport0
...
# customize the right y axis label on viewport0
		...
		yaxislabel.setFont("Arial,Normal,20")	
#
# customize the title of the plot (seventh line in the ini data file)
...
#
dbiName     = "fooo"
iniFilename = "/cwms/g7cwmspd/plotFiles/plotDataNWOotherres.ini"
