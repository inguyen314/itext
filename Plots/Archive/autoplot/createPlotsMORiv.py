...
#-----------------------------------------#
def plotData (dbi, flow1, flow2, flow3, flow4, flow5, flow6, titlename, width, height, jpgname, quality) :
#
	if debugOutput :
		print "Flow1 		= %s" % flow1
		print "Flow2 		= %s" % flow2
...
# define the plot layout
		...
		topView.addCurve("Y1",flow6DC)
		plot.configurePlotLayout(layout)
		plot.showPlot()
		plot.setLegendLabelText(flow1DC,"Gavins Point Dam-Missouri")
		plot.setLegendLabelText(flow2DC,"Sioux City-Missouri")
		plot.setLegendLabelText(flow3DC,"Omaha-Missouri")
		plot.setLegendLabelText(flow4DC,"Nebraska City-Missouri")
		plot.setLegendLabelText(flow5DC,"St. Joseph-Missouri")
		plot.setLegendLabelText(flow6DC,"Kansas City-Missouri")
...
#
# set line color, style, width for time series ..... flow6Data
                lineColor6=plot.getCurve(flow6Data)
                lineColor6.setLineColor("blue")
                lineColor6.setLineStyle("Solid")
...
#
dbiName     = "foo"
iniFilename = "/cwms/g7cwmspd/plotFiles/plotDataMORiv.ini"
...
while 1 :
	try :	
		...
		iniFlow6 	= iniFile.readline().strip()
	...
	plotData(dbi, iniFlow1, iniFlow2, iniFlow3, iniFlow4, iniFlow5, iniFlow6, iniTitle, plotWidth, plotHeight, iniFname, plotQuality)
