...
#-----------------------------------------#
def plotData (dbi, elev, inflow, release, stor, prec, basefc, titlename, width, height, jpgname, quality) :
...
# set line color, style, width for time series ..... stor
                ...
                lineColor4.setSymbolInterval(1)
...
# define the marker lines ... base of flood control pool as listed in ini data file - sixth line 
		...
		marker1.labelText = "Base of Flood Control Pool"
...
#
dbiName     = "fooo"
iniFilename = "/cwms/g7cwmspd/plotFiles/plotDataNWOres2.ini"
...
while 1 :
	...
	plotData(dbi, iniElev, iniInflow, iniRelease, iniStor, iniPrec, iniBaseFC, iniTitle, plotWidth, plotHeight, iniFname, plotQuality)
