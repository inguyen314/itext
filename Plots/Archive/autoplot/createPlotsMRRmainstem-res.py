...
#-----------------------------------------#
def plotData (dbi, elevation, inflow, release, titlename, width, height, jpgname, quality) :
...
#
dbiName     = "foo"
iniFilename = "/cwms/g7cwmspd/plotFiles/plotDataMRRmainstem-res.ini"
...
while 1 :
	...
	plotData(dbi, iniElevation, iniInflow, iniRelease, iniTitle, plotWidth, plotHeight, iniFname, plotQuality)
