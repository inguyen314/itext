...
# define the plot layout
		...
		plot.showPlot()
		plot.setLegendLabelText(flow1DC,"Sioux City-Missouri")
		plot.setLegendLabelText(flow2DC,"Decatur-Missouri")
		plot.setLegendLabelText(flow3DC,"Omaha-Missouri")
		plot.setLegendLabelText(flow4DC,"Nebraska City-Missouri")
		plot.setLegendLabelText(flow5DC,"Rulo-Missouri")
		plot.setLegendLabelText(flow6DC,"St Joseph-Missouri")
...
#
dbiName     = "fo"
iniFilename = "/cwms/g7cwmspd/plotFiles/plotDataMORiv1.ini"
