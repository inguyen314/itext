...
from Server_Utils import lineNo, outputDebug, retrieveCrest, retrieveCrestDate, retrieveNWSDay1, retrieveNWSDay2, retrieveNWSDay3, retrieveNWSForecastDate, \
    ...
    retrieveNWSDay1Date, retrieveNWSDay2Date, retrieveNWSDay3Date, retrievePrecipLake, retrieveMidnightOutflow, \
    retrieveEveningOutflow, retrieveRuleCurve, retrieveCrestLake, retrieveCrestDateLake
...
def titleBlock(debug, TitleBlock,) :
    ...
    #
    # How to change IMG size: Table1Columns - 3
    #
...
def table1Heading(debug, Table,) :
   ...
   # QUERY TO GET NWS Date Day
    ...
    #5-10
    CellData = Phrase(Chunk('National Weather Service River Forecast', TableLayoutDict['Table1']['TextFont2']))
