...
BulletinFilename = HomeDirectory + 'NWO_Reservoir_Bulletin_iText.pdf'
        ...
        for data in DataOrder :
            ...
            # Elevation
                ...
                if (DataBlockDict['DataBlocks']['Table1Data3']['PocaSpecialChar'] and project == 'POCA') or \
                    ...
                    (DataBlockDict['DataBlocks']['Table1Data3']['Sc12SpecialChar'] and project == 'SC12') :
...
try :
    ...
    EndTwStr            = EndTw.strftime('%d%b%Y 0100') # End of time window for the database formatted as ddmmmyyyy 2400
    ...
    for location in locations :
        PublicName = retrievePublicName(debug, location)
