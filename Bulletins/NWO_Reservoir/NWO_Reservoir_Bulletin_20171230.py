...
# PC pathnames
'''
iTextPdfPathname = "D:\\Projects\\HEC_DSSVue_Scripts\\MRBWM\\NWO-CWMS2_Scripts\\Bulletins\\itextpdf.jar"
BulletinFilename = "D:\\Projects\\HEC_DSSVue_Scripts\\MRBWM\\NWO-CWMS2_Scripts\\Bulletins\\NWO_Reservoir\\NWO_Reservoir_Bulletin_iText.pdf"
...
BulletinPropertiesPathname = "D:\\Projects\\HEC_DSSVue_Scripts\\MRBWM\\NWO-CWMS2_Scripts\\Bulletins\\NWO_Reservoir\\NWO_Reservoir_Bulletin_Properties_20171231.txt"
'''
# Unix pathnames
...
BulletinTsFilePathname = '/netapp/g7cwmspd/cronjobs/Bulletins/Bulletins_Time_Series_20171231.txt'
BulletinPropertiesPathname = '/netapp/g7cwmspd/cronjobs/Bulletins/NWO_Reservoir/NWO_Reservoir_Bulletin_Properties_20171231.txt'
    ...
    for project in DataBlockDict['DataBlocks'][TableDataName]['ProjectList'] :
        ...
        for data in DataOrder :
            ...
            # Elevation
                ...
                if (DataBlockDict['DataBlocks']['Table1Data3']['PocaSpecialChar'] or DataBlockDict['DataBlocks']['Table1Data3']['Sc09SpecialChar'] or 
                    DataBlockDict['DataBlocks']['Table1Data3']['Sc12SpecialChar']) and \
                    (project == 'POCA' or project == 'SC09' or project == 'SC12') :
...
def table1Heading(  debug,  # Set to True to print all debug statements
    ...
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    Cell = createCell(debug, Phrase(Chunk('Daily Elev Change (ft)', TableLayoutDict['Table1']['TextFont'])), 2, TableLayoutDict['Table1']['ColSpan'], 
