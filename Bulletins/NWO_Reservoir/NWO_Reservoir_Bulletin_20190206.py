...
BulletinFilename = "D:\\Projects\\HEC_DSSVue_Scripts\\MRBWM\\NWO-CWMS2_Scripts\\cronjobs\\Bulletins\\NWO_Reservoir\\NWO_Reservoir_Bulletin.pdf"
CsvFilename = "D:\\Projects\\HEC_DSSVue_Scripts\\MRBWM\\NWO-CWMS2_Scripts\\cronjobs\\Bulletins\\NWO_Reservoir\\NWO_Reservoir_Bulletin.csv"
CronjobsDirectory = "D:\\Projects\\HEC_DSSVue_Scripts\\MRBWM\\NWO-CWMS2_Scripts\\cronjobs"
BulletinPropertiesPathname = "D:\\Projects\\HEC_DSSVue_Scripts\\MRBWM\\NWO-CWMS2_Scripts\\cronjobs\\Bulletins\\NWO_Reservoir\\NWO_Reservoir_Bulletin_Properties.txt"
'''
    ...
    for project in DataBlockDict['DataBlocks'][TableDataName]['ProjectList'] :
        ...
        for data in DataOrder :
            ...
            # Elevation
                ...
                if (DataBlockDict['DataBlocks']['Table1Data3']['PocaSpecialChar'] and project == 'POCA') or \
                    (DataBlockDict['DataBlocks']['Table1Data3']['Sc09SpecialChar'] and project == 'SC09') or \
                    (DataBlockDict['DataBlocks']['Table1Data3']['Sc12SpecialChar'] and project == 'SC12') or \
                    (DataBlockDict['DataBlocks']['Table1Data3']['Pa11SpecialChar'] and project == 'PA11') :
                    if project == 'POCA' : SpecialChar = PocaSpecialChar
                    elif project == 'SC09' : SpecialChar = Sc09SpecialChar
                    elif project == 'SC12' : SpecialChar = Sc12SpecialChar
                    elif project == 'PA11' : SpecialChar = Pa11SpecialChar
                ...
                try :
                    if project == 'LAUD' and DataBlockDict['DataBlocks']['Table1Data3']['LaudSpecialChar'] and data == 'Storage' :
                        ...
                        if project in ['SYS'] :
                            ...
                            # Set the database time zone to GMT-6 if not in the specified list
