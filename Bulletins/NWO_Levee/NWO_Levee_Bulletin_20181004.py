...
BulletinFilename = HomeDirectory + 'NWO_Levee_Bulletin.pdf'
CsvFilename = HomeDirectory + 'NWO_Levee_Bulletin.csv'
BulletinTsFilePathname = HomeDirectory + 'Bulletins_Time_Series.txt'
BulletinPropertiesPathname = BulletinScriptDirectory + 'NWO_Levee_Bulletin_Properties.txt'
'''
...
def table1Footnote( debug,          # Set to True to print all debug statements
    ...
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    Cell = createCell(debug, Phrase(Chunk('NWS Operational Fcst Including QPF', Font7)), TableLayoutDict['Table1']['RowSpan'], 
        Table1Columns, Element.ALIGN_LEFT, TableLayoutDict['Table1']['VerticalAlignment'], TableLayoutDict['Table1']['CellPadding'], TableLayoutDict['Table1']['BorderColors'], 
        TableLayoutDict['Table1']['BorderWidths'], TableLayoutDict['Table1']['VariableBorders'], TableLayoutDict['Table1']['BackgroundColor'])
    Cell.setBorder(Rectangle.NO_BORDER)
    TableFootnote.addCell(Cell)
