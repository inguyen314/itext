...
Author: 
Last Updated: 
Description: Create the NWO Bighorn River Basin Bulletin
'''
...
if OsName[ : 7] == 'windows' : 
    ...
    ScriptDirectory = BulletinsDirectory + 'NWO_Bighorn\\'
    BulletinFilename = BulletinsDirectory + 'NWO_Bighorn_Bulletin.pdf'
    ArchiveBulletinFilename = BulletinsDirectory + 'NWO_Bighorn%s.pdf'
    CsvFilename = BulletinsDirectory + 'NWO_Bighorn_Bulletin.csv'
    BulletinPropertiesPathname = ScriptDirectory + 'NWO_Bighorn_Bulletin_Properties.txt'
else :
    # Server pathnames
    ...
    ScriptDirectory += '/'
    BulletinFilename = BulletinsDirectory + 'NWO_Bighorn_Bulletin.pdf'
    ArchiveBulletinFilename = BulletinsDirectory + 'NWO_Bighorn_%s.pdf'
    CsvFilename = BulletinsDirectory + 'NWO_Bighorn.csv'
    BulletinPropertiesPathname = ScriptDirectory + 'NWO_Bighorn_Bulletin_Properties.txt'    
    ...
    for project in DataBlockDict['DataBlocks'][TableDataName]['ProjectList'] :
        ...
        for data in DataOrder :
            ...
            if data == 'PublicName' :
                ...
                if project == 'BUBI' : BulletinName = BulletinName + '*' 
                elif project == 'BAGL' : BulletinName = BulletinName + '**' 
            ...
            # FC elevation
                ...
                try :
                    if project in ['BULA', 'BUBI', 'YETL', 'BOYN'] : # BUBI does not have a rating curve in the database
                        FcElevZone = Null
                        # Create a formatted string that will be added to the table
                        CellData = Phrase(Chunk(Null, TextFont))
                    else :
            ...
            # Elevation
                ...
                try :
                    if project in ['SYS'] :
                        ...
                        NwkProjects = ['BULA', 'BOYN', 'BUBI', 'YETL']
                ...
                try :
                    if project in ['SYS'] :
                        ...
                        if project == 'BUBI' and data == 'Storage' :
                            TscPathname = StorInstHourRawUsbr % project

                        # Set the database time zone if not in the specified list
                        if project not in ['FTPK', 'GARR', 'OAHE', 'BEND', 'FTRA', 'GAPT'] :
                            CwmsDb.setTimeZone('Etc/GMT+6')
                            # Most of NWK projects have 0600 values displayed in bulletin. Set time zone to GMT-6 and change the time windows so 0600 values are retrieved from database
                            if project in ['BULA', 'BOYN', 'BUBI', 'YETL'] : 
...
def table1Footnote( debug,          # Set to True to print all debug statements
    ...
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    Cell = createCell(debug, Phrase(Chunk('Data for NWK projects are 0600 values except for Stockton, Harry S Truman, and Bagnell. Those projects are 0000 values. Bagnell Dam is owned and operated by Ameren UE of Saint Louis MO.', 
...
def table1Heading(  debug,  # Set to True to print all debug statements
    ...
    # Column 0 Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('USBR Reservoirs', Font3))
...
def table2Heading(  debug,  # Set to True to print all debug statements
    ...
    # Column 0-1 Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('River Gages', Font3))
    Cell = createCell(debug, CellData, TableLayoutDict2['Table2']['RowSpan'], 2, Element.ALIGN_CENTER,
        TableLayoutDict2['Table2']['VerticalAlignment'], TableLayoutDict2['Table2']['CellPadding'], [Color2, Color3, Color2, Color2],
        [1, 0.5, 0.25, 1], TableLayoutDict2['Table2']['VariableBorders'], Color5)
    Cell.setFixedHeight(Row1Height)
    Table.addCell(Cell)
    ...
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('Current Data', Font3))
    Cell = createCell(debug, CellData, TableLayoutDict2['Table2']['RowSpan'], 3, Element.ALIGN_CENTER,
        TableLayoutDict2['Table2']['VerticalAlignment'], TableLayoutDict2['Table2']['CellPadding'], [Color2, Color3, Color2, Color3],
        [1, 0.5, 0.25, 0.5], TableLayoutDict2['Table2']['VariableBorders'], Color5)
    Cell.setFixedHeight(Row1Height)
    Table.addCell(Cell)
    
    # Column 5-8 Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('Flood Stages (ft)', Font3))
    Cell = createCell(debug, CellData, TableLayoutDict2['Table2']['RowSpan'], 4, Element.ALIGN_CENTER,
        TableLayoutDict2['Table2']['VerticalAlignment'], TableLayoutDict2['Table2']['CellPadding'], [Color2, Color3, Color2, Color3],
        [1, 0.25, 0.25, 0.5], TableLayoutDict2['Table2']['VariableBorders'], Color5)
    Cell.setFixedHeight(Row1Height)
    Table.addCell(Cell)
    ...
    Cell = createCell(debug, CellData, TableLayoutDict2['Table2']['RowSpan'], 2, Element.ALIGN_CENTER,
        TableLayoutDict2['Table2']['VerticalAlignment'], TableLayoutDict2['Table2']['CellPadding'], [Color2, Color2, Color2, Color3],
        [1, 1, 0.25, 0.5], TableLayoutDict2['Table2']['VariableBorders'], Color5)
    Cell.setFixedHeight(Row1Height)
    Table.addCell(Cell)
    	
	# Blank Column 0 Sub-Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('Name', TableLayoutDict2['Table2']['TextFont']))
    Cell = createCell(debug, CellData, TableLayoutDict2['Table2']['ColSpan'], 2, Element.ALIGN_CENTER,
		TableLayoutDict2['Table2']['VerticalAlignment'], TableLayoutDict2['Table2']['CellPadding'], [Color2, Color3, Color2, Color2],
        [0.25, 0.5, 0.25, 1], TableLayoutDict2['Table2']['VariableBorders'], Color6)
    Table.addCell(Cell)
    
    # Column 1-2 Sub-Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('Location', TableLayoutDict2['Table2']['TextFont']))
    Cell = createCell(debug, CellData, TableLayoutDict2['Table2']['RowSpan'], 2,
        Element.ALIGN_CENTER, TableLayoutDict2['Table2']['VerticalAlignment'], TableLayoutDict2['Table2']['CellPadding'],
        [Color2, Color2, Color2, Color3], [0.25, 0.25, 0.25, 0.5], TableLayoutDict2['Table2']['VariableBorders'],
        Color6)
    Table.addCell(Cell)
    
    # Column 3-4 Sub-Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('Stage\n(ft)', TableLayoutDict2['Table2']['TextFont']))
    Cell = createCell(debug, CellData, TableLayoutDict2['Table2']['RowSpan'], 2,
        Element.ALIGN_CENTER, TableLayoutDict2['Table2']['VerticalAlignment'], TableLayoutDict2['Table2']['CellPadding'], [Color2, Color3, Color2, Color2],
        [0.25, 0.5, 0.25, 0.25], TableLayoutDict2['Table2']['VariableBorders'], Color6)
    Table.addCell(Cell)
    
    # Column 5 Sub-Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('Dly Stage\nChange(ft)', TableLayoutDict2['Table2']['TextFont']))
    Cell = createCell(debug, CellData, TableLayoutDict2['Table2']['ColSpan'], 2,
        Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, TableLayoutDict2['Table2']['CellPadding'], [Color2, Color2, Color2, Color3],
        [0.25, 0.25, 0.25, 0.5], TableLayoutDict2['Table2']['VariableBorders'], Color6)
    Table.addCell(Cell)
    
    # Column 6 Sub-Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('Flow\n(cfs)', TableLayoutDict2['Table2']['TextFont']))
    Cell = createCell(debug, CellData, TableLayoutDict2['Table2']['ColSpan'], 2,
        Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, TableLayoutDict2['Table2']['CellPadding'], TableLayoutDict2['Table2']['BorderColors'], TableLayoutDict2['Table2']['BorderWidths'],
        TableLayoutDict2['Table2']['VariableBorders'], Color6)
    Table.addCell(Cell)
    	
	 # Column 7 Sub-Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('Action', TableLayoutDict2['Table2']['TextFont']))
    Cell = createCell(debug, CellData, TableLayoutDict2['Table2']['ColSpan'], 2, 
        Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, TableLayoutDict2['Table2']['CellPadding'], TableLayoutDict2['Table2']['BorderColors'],
        TableLayoutDict2['Table2']['BorderWidths'], TableLayoutDict2['Table2']['VariableBorders'], Color6)
    Table.addCell(Cell)
    
    # Column 8 Sub-Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('Minor', TableLayoutDict2['Table2']['TextFont']))
    Cell = createCell(debug, CellData, TableLayoutDict2['Table2']['ColSpan'], 2, 
        Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, TableLayoutDict2['Table2']['CellPadding'], TableLayoutDict2['Table2']['BorderColors'],
        TableLayoutDict2['Table2']['BorderWidths'], TableLayoutDict2['Table2']['VariableBorders'], Color6)
    Table.addCell(Cell)
    ...
    # Column 9 Sub-Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('Moderate', TableLayoutDict2['Table2']['TextFont']))
    Cell = createCell(debug, CellData, 2, TableLayoutDict2['Table2']['ColSpan'],
        Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, TableLayoutDict2['Table2']['CellPadding'], [Color2, Color3, Color2, Color2],
        [0.25, 0.5, 0.25, 0.25], TableLayoutDict2['Table2']['VariableBorders'], Color6)
    Table.addCell(Cell)
    
    # Column 10 Sub-Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('Major', TableLayoutDict2['Table2']['TextFont']))
    Cell = createCell(debug, CellData, 2, TableLayoutDict2['Table2']['ColSpan'], Element.ALIGN_CENTER, Element.ALIGN_BOTTOM,
        TableLayoutDict2['Table2']['CellPadding'], [Color2, Color2, Color2, Color3], [0.25, 0.25, 0.25, 0.5],
        TableLayoutDict2['Table2']['VariableBorders'], Color6)
    Table.addCell(Cell)
    
    # Column 11 Sub-Heading
    # createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    CellData = Phrase(Chunk('Date', TableLayoutDict2['Table2']['TextFont']))
    Cell = createCell(debug, CellData, 2, TableLayoutDict2['Table2']['ColSpan'],
        Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, TableLayoutDict2['Table2']['CellPadding'], TableLayoutDict2['Table2']['BorderColors'],
        TableLayoutDict2['Table2']['BorderWidths'], TableLayoutDict2['Table2']['VariableBorders'], Color6)
    Table.addCell(Cell)
    ...
    Cell = createCell(debug, CellData, 2, TableLayoutDict2['Table2']['ColSpan'],
        Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, TableLayoutDict2['Table2']['CellPadding'], TableLayoutDict2['Table2']['BorderColors'],
        [0.25, 1, 0.25, 0.25], TableLayoutDict2['Table2']['VariableBorders'], Color6)
    Table.addCell(Cell)
