...
BulletinFilename = "D:\\Projects\\HEC_DSSVue_Scripts\\MRBWM\\NWO-CWMS2_Scripts\\Bulletins\\NWK_Lake_Weekly\\7daylak3.pdf"
ArchiveBulletinFilename = "D:\\Projects\\HEC_DSSVue_Scripts\\MRBWM\\NWO-CWMS2_Scripts\\Bulletins\\NWK_Lake_Weekly\\7daylak3_%s.pdf"
CsvFilename = "D:\\Projects\\HEC_DSSVue_Scripts\\MRBWM\\NWO-CWMS2_Scripts\\Bulletins\\NWK_Lake_Weekly\\7daylak3.csv"
BulletinTsFilePathname = "D:\\Projects\\HEC_DSSVue_Scripts\\MRBWM\\NWO-CWMS2_Scripts\\Bulletins\\Bulletins_Time_Series.txt"
BulletinPropertiesPathname = "D:\\Projects\\HEC_DSSVue_Scripts\\MRBWM\\NWO-CWMS2_Scripts\\Bulletins\\NWK_Lake_Weekly\\NWK_Lake_Properties.txt"
        ...
        for data in DataOrder :
            ...
            # 4 FlowTotal 
                ...
                if (projectFlowTot == True) :
                    # Change default cell properties
                    if x == len(dateArray)-1 :
                        BorderWidths = [0.25, 1, 0.25, 1] #[Top, Right, Bottom, Left]
                    else :
                        BorderWidths = [0.25, 1, 0.25, 1]
                    
                    if project == 'BAGL' or project == 'LOVL' :
                        BorderWidths = [0.25, 1, 1, 1] #[Top, Right, Bottom, Left]
                            ...
                            try :
                                ...
                                for x in range(0,len(dateArray),1):
                                    ...
                                    if x == len(dateArray)-1 :
                                        ...
                                        BorderColors = TableLayoutDict[TableName]['BorderColors']
                                        '''
                                        elif project  == 'BAGL' or project  == 'LOVL' :
                                            BorderWidths = [0.25, 1, 1, 0.25] #[Top, Right, Bottom, Left]
                                            if x == 0 :
                                                BorderWidths = [0.25, 1, 1, 0.5] #[Top, Right, Bottom, Left]
                                                BorderColors = [Color2, Color2, Color2, Color3]
                                        '''
                                    elif x == 0 :
                                        BorderWidths = [0.25, 0.25, 0.25, 0.5] #[Top, Right, Bottom, Left]
...
def table1Heading(  debug,  # Set to True to print all debug statements
    ...
    #createCell(debug, CellData, RowSpan, ColSpan, HorizontalAlignment, VerticalAlignment, CellPadding, BorderColors, BorderWidths, VariableBorders, BackgroundColor)
    #0
    CellData = Phrase(Chunk('Projects', Font4))
...
try :    
    ...
    '''
    DataBlocks2 = ['Data5', 'Data6']
    for DataBlock2 in DataBlocks2 :
        startTime = TrimTwStr
        endTime = EndTwStr
        Table1 = table1Data(debug, Table1, 'Table1', DataBlock2, startTime, endTime, date_list, LocationDict2)
    '''
        
    #
    # Create bulletin footer
    #
