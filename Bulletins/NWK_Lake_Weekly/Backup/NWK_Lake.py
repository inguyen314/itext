            ...
            # 3 Inflow
                ...
                if(projectInflow == True) :
                    ...
                    if str(DataBlockDict['DataBlocks'][TableDataName][data]) != 'None' :
                        if DataBlockDict['DataBlocks'][TableDataName][data] % project in PathnameList :
                            TscPathname = DataBlockDict['DataBlocks'][TableDataName][data] % project    
                        elif '%s.Flow-In.Ave.1Day.1Day.Combined-rev' % project in PathnameList :
                            TscPathname = '%s.Flow-In.Ave.1Day.1Day.Combined-rev' % project
            ...
            # 4 FlowTotal 
                ...
                if (projectFlowTot == True) :
                    ...
                    if str(DataBlockDict['DataBlocks'][TableDataName][data]) != 'None' :
                        if DataBlockDict['DataBlocks'][TableDataName][data] % project in PathnameList :
                            TscPathname = DataBlockDict['DataBlocks'][TableDataName][data] % project    
                        elif '%s.Flow-Total.Ave.1Day.1Day.Combined-rev' % project in PathnameList :
                            TscPathname = '%s.Flow-Total.Ave.1Day.1Day.Combined-rev' % project
