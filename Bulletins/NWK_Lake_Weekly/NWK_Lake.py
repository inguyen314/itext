...
if OsName[ : 7] == 'windows' : 
    ...
    ScriptDirectory = BulletinsDirectory + 'NWK_Lake_Weekly\\'
    BulletinFilename = BulletinsDirectory + '7daylak3.pdf'
    ArchiveBulletinFilename = BulletinsDirectory + '7daylak3_%s.pdf'
    CsvFilename = BulletinsDirectory + '7daylak3.csv'
    BulletinPropertiesPathname = ScriptDirectory + 'NWK_Lake_Properties.txt'
else :
    # Server pathnames
...
try :    
    ...
    ProjectDateTimeStr  = EndTw.strftime('%m-%d-%Y 00:00') # Project date and time for bulletin formatted as mm-dd-yyyy 2400
    ...
    for DataBlock in DataBlocks :
        startTime = TrimTwStr
        endTime = EndTwStr
        Table1 = table1Data(debug, Table1, 'Table1', DataBlock, startTime, endTime, date_list)
