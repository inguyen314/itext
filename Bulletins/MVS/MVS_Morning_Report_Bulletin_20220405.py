            ...
            # 4 - Stage
                ...
                if project in GroupSet:
                    ...
                    if TscPathname == "Mel Price Pool-Mississippi.Stage.Inst.30Minutes.0.29": 
                       ...
                       print 'TscPathname1 = ' + str(TscPathname) + project 
                elif project in GroupSetLPMS:
                     TscPathname = StageInst2HoursLpmsRaw % project
                     print 'TscPathname2 = ' + str(TscPathname) + project
                else: 
                    TscPathname = DataBlockDict['DataBlocks'][TableDataName][data] % project
                    print 'TscPathname3 = ' + str(TscPathname) + project

                    if TscPathname == "Cairo-Ohio.Stage.Inst.30Minutes.0.lrgsShef-rev":
                        TscPathname = StageInstHourRevLrgs % project
                        print 'TscPathname4 = ' + str(TscPathname) + project
                    else:
                        TscPathname = StageInst15minRevLrgs % project
                    print 'TscPathname5 = ' + str(TscPathname) + project
                    
                try :
                    print 'TscPathname, startTime, endTime = ' + str(TscPathname) + ' - ' + str(startTime) + ' - ' + str(endTime)
                    Tsc = CwmsDb.get(TscPathname, startTime, endTime)
                    print 'TscPathname6 = ' + str(Tsc)
