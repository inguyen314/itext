...
CsvFilename = HomeDirectory + 'MRBWM_River_Daily_iText.csv'
...
try :    
	...
	if DataBlock == 'Data1' or DataBlock == 'Data2':
	   startTime = TrimTwStr
	   endTime = EndTwStr
           Table1, CsvData = table1Data(debug, Table1, 'Table1', DataBlock, startTime, endTime, TribTrimTwStr, SysEndTwStr, CsvData)
